...
def compute_tool_integrity(
    ...
    if files:
        ...
        sorted_files = [
            {"path": f.get("path", ""), "sha256": f.get("sha256", "")} for f in sorted_files
        ]

    # Build canonical payload
    payload = {"tool_id": tool_id, "version": version, "manifest": manifest, "files": sorted_files}
...
def compute_knowledge_integrity(
    ...
    Args:
        id: Knowledge entry identifier (e.g., "20260124-api-patterns")
        version: Semver version string
