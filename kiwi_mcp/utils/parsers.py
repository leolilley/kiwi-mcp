    ...
    if category_from_xml and category_from_path:
        if category_from_xml != category_from_path:
            raise ValueError(
                ...
                f"    3. Run: mcp__kiwi_mcp__execute(item_type='directive', action='update', item_id='{directive_name}')\n"
                f"\n"
    ...
    if category_from_frontmatter and category_from_path:
        if category_from_frontmatter != category_from_path:
            raise ValueError(
                ...
                f"    3. Run: mcp__kiwi_mcp__execute(item_type='knowledge', action='update', item_id='{zettel_id}')\n"
                f"\n"
