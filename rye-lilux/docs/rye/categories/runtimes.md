**Source:** Original implementation: `.ai/tools/rye/runtimes/` in kiwi-mcp
...
| **Discoverability** | Auto-discovered by RYE |
...
Tool with __executor_id__ = "python_runtime"
    │
    ├─→ Universal Executor loads python_runtime.py
...
- [[primitives]] - Layer 1 primitives that runtimes delegate to
- [[overview]] - All categories
- [[../universal-executor/routing]] - How routing works with runtimes
