...
# Universal Executor Routing

## Routing Logic

The universal executor is **fully data-driven** - no hardcoded executor IDs!
...
```
Tool Call: subprocess(command="echo", args=["hello"])
    │
    ├─→ Universal Executor loads .ai/tools/rye/primitives/subprocess.py
...
```
rye/executor/universal_executor.py:execute(subprocess.py)
    │
...
Tool Call: python_runtime(script="print('hello')")
    │
    ├─→ Universal Executor loads .ai/tools/rye/runtimes/python_runtime.py
...
```
rye/executor/universal_executor.py:execute(python_runtime.py)
    │
...
Tool Call: git(command="status")
    │
    ├─→ Universal Executor loads .ai/tools/rye/capabilities/git.py
...
```
rye/executor/universal_executor.py:execute(git.py)
    │
...
- [[overview]] - Universal executor architecture
- [[bundle/structure]] - Tool organization
- [[categories/primitives]] - Primitive implementations
- [[categories/runtimes]] - Runtime specifications
