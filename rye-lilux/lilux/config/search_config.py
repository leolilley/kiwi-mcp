...
class SearchConfig:
    ...
    def from_env(cls) -> "SearchConfig":
        ...
        return cls(
            strategy=os.getenv("LILUX_SEARCH_STRATEGY", "keyword"),
            vector_backend=os.getenv("LILUX_VECTOR_BACKEND"),
            embedding_model=os.getenv("LILUX_EMBEDDING_MODEL", "all-MiniLM-L6-v2"),
        )
