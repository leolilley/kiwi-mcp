...
# Load safety_harness module from .ai/tools/threads using importlib
# This avoids conflict with the existing safety_harness package in the project root
_harness_path = Path(__file__).parent.parent.parent / ".ai" / "tools" / "threads" / "safety_harness.py"
